...
import { IPeticionPutRequestAttributes
} from './PeticionPutRequestAttributes';

export type IPeticionPutRequest = IJsonApiObject<IPeticionPutRequestAttributes>;

export type IPeticionPutRequestCollection = IJsonApiCollection<IPeticionPutRequestAttributes>;
