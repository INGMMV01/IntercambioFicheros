...
import { IItemResponseAttributes
} from './ItemResponseAttributes';

export type IItemResponse = IJsonApiObject<IItemResponseAttributes>;

export type IItemResponseCollection = IJsonApiCollection<IItemResponseAttributes>;
